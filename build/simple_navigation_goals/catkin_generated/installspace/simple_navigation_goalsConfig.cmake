...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gqy/Desktop/simple_navigation_goals_readtxt/install/${idir}'.  Ask the maintainer 'gqy <gqy@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gqy/Desktop/simple_navigation_goals_readtxt/install/lib;/home/gqy/navigation_indigo_ws/devel/lib;/opt/ros/indigo/lib)
